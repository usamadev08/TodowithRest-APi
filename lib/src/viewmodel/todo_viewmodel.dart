import 'package:apitutorials/helper/navigator.dart';
import 'package:apitutorials/helper/network.dart';
import 'package:apitutorials/src/model/todo_model.dart';
import 'package:apitutorials/src/view/todo_create.dart';
import 'package:apitutorials/src/view/todo_edit.dart';
import 'package:apitutorials/src/view/todo_list.dart';
...
class TodoViewModel extends ChangeNotifier {
  ...
  getAllTodos() async {
    ...
    final resData = await ApiProvider().get('/yt-todo-app');
    allTodos =
